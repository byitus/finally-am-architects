...
let PROJECTS = [
  {
    id: 'p1', cat: 'healthcare',
    title: 'Aasi Multicare Hospital',
    location: 'Tamil Nadu',
    year: '2025',
    size: 'project--lg',
    img: 'images/p-aasi-hero.jpg',
    gallery: ['images/p-aasi-01.jpg', 'images/p-aasi-02.jpg', 'images/p-aasi-03.jpg', 'images/p-aasi-04.jpg'],
    tags: ['Healthcare', 'Civic'],
    desc: 'A multi-speciality hospital planned around patient well-being, operational efficiency, and the capacity to adapt as healthcare needs change.',
    body: [
      'Our hospital designs prioritise patient well-being, operational efficiency, and adaptability to future healthcare needs. Aasi Multicare brings consulting suites, in-patient wards, diagnostics and a theatre wing together under one calm, legible plan.',
      'We integrate evidence-based planning, advanced medical technologies, and sustainable design principles to create healing environments that support both patients and medical professionals.',
      'Every element — from circulation flow to lighting — is thoughtfully considered to enhance safety, comfort, and functionality.',
    ],
    facts: { area: 'TBC', completion: '2025', team: 'AM Architects' },
  },
  {
    id: 'p2', cat: 'hospitality',
    title: 'Rethinam 3-Star Hotel',
    location: 'Tamil Nadu',
    year: '2025',
    size: 'project--md',
    img: 'images/p-rethinam-hero.jpg',
    gallery: ['images/p-rethinam-01.jpg', 'images/p-rethinam-02.jpg', 'images/p-rethinam-03.jpg', 'images/p-rethinam-04.jpg', 'images/p-rethinam-05.jpg'],
    tags: ['Hospitality', 'Hotel'],
    desc: 'A thoughtfully designed 3-star hotel that balances comfort, functionality, and aesthetic appeal.',
    body: [
      'AM Architects presents a thoughtfully designed 3-star hotel that balances comfort, functionality, and aesthetic appeal.',
      'Focused on delivering a welcoming guest experience, the design features efficient space planning, modern amenities, and a warm ambiance suited for both business and leisure travellers.',
      'Our approach ensures a cost-effective yet memorable hospitality environment.',
    ],
    facts: { area: 'TBC', completion: '2025', team: 'AM Architects' },
  },
  {
    id: 'p3', cat: 'hospitality',
    title: 'Ozone 3-Star Hotel',
    location: 'Tamil Nadu',
    year: '2025',
    size: 'project--md',
    img: 'images/p-ozone-hero.jpg',
    gallery: ['images/p-ozone-01.jpg', 'images/p-ozone-02.jpg', 'images/p-ozone-03.jpg', 'images/p-ozone-04.jpg', 'images/p-ozone-05.jpg', 'images/p-ozone-06.jpg', 'images/p-ozone-07.jpg'],
    tags: ['Hospitality', 'Hotel'],
    desc: 'A second hospitality commission — efficient space planning, modern amenities, and a warm ambiance for business and leisure alike.',
    body: [
      'AM Architects presents a thoughtfully designed 3-star hotel that balances comfort, functionality, and aesthetic appeal.',
      'Focused on delivering a welcoming guest experience, the design features efficient space planning, modern amenities, and a warm ambiance suited for both business and leisure travellers.',
      'Our approach ensures a cost-effective yet memorable hospitality environment.',
  ...
  {
    id: 'p4', cat: 'hospitality',
    title: 'DD Beach Resort',
    location: 'Coastal Tamil Nadu',
    year: '2025',
    size: 'project--lg',
    img: 'images/p-resort-hero.jpg',
    gallery: ['images/p-resort-01.jpg', 'images/p-resort-02.jpg'],
    tags: ['Hospitality', 'Resort', 'Coastal'],
    desc: 'A beachfront resort that embraces the natural beauty of the coastline while offering a luxurious and relaxing retreat.',
    body: [
      'At AM Architects, our beach resort designs embrace the natural beauty of the coastline while offering a luxurious and relaxing retreat.',
      'We prioritise seamless integration with the surrounding landscape, featuring spacious accommodations, open-air spaces, and sustainable elements.',
      'The design creates an unforgettable experience for guests, combining comfort, tranquillity, and breathtaking ocean views.',
    ],
    facts: { area: 'TBC', completion: '2025', team: 'AM Architects' },
  },
  {
    id: 'p5', cat: 'hospitality',
    title: 'MS Mahal',
    location: 'Tamil Nadu',
    year: '2025',
    size: 'project--md',
    img: 'images/p-mahal-hero.jpg',
    gallery: ['images/p-mahal-01.jpg', 'images/p-mahal-02.jpg', 'images/p-mahal-03.jpg', 'images/p-mahal-04.jpg', 'images/p-mahal-05.jpg'],
    tags: ['Hospitality', 'Events'],
    desc: 'A generous events and gathering hall — open volumes, natural materials, and a strong civic presence on the street.',
    body: [
      'MS Mahal is planned as a place of gathering: a generous hall for weddings and community occasions, supported by dining, preparation and parking arranged so that large crowds move without friction.',
      'The design emphasises open spaces and natural materials, offering a calm, dignified backdrop to the events it holds.',
      'Comfort, functionality and sustainability drive the detailing throughout.',
    ],
    facts: { area: 'TBC', completion: '2025', team: 'AM Architects' },
  },
  {
    id: 'p6', cat: 'residential',
    title: 'SMKM Farm House',
    location: 'Tamil Nadu',
    year: '2025',
    size: 'project--lg',
    img: 'images/p-smkm-hero.jpg',
    gallery: ['images/p-smkm-01.jpg', 'images/p-smkm-02.jpg', 'images/p-smkm-03.jpg', 'images/p-smkm-04.jpg'],
    tags: ['Residential', 'Farm House'],
    desc: 'A timeless farmhouse blending rustic charm with modern living — open spaces, natural materials, and a connection to the countryside.',
    body: [
      'AM Architects creates timeless farmhouse designs that blend rustic charm with modern living.',
      'Our approach emphasises open spaces, natural materials, and a connection to the surrounding countryside, offering a peaceful retreat from urban life.',
      'The design prioritises comfort, functionality, and sustainability, creating an ideal home where nature and contemporary living coexist harmoniously.',
    ],
    facts: { area: 'TBC', completion: '2025', team: 'AM Architects' },
  },
  {
    id: 'p7', cat: 'commercial',
    title: "Kavins Bake House",
    location: 'Tamil Nadu',
    year: '2025',
    size: 'project--sm',
    img: 'images/p-kavins-hero.jpg',
    gallery: ['images/p-kavins-01.jpg', 'images/p-kavins-02.jpg', 'images/p-kavins-03.jpg', 'images/p-kavins-04.jpg', 'images/p-kavins-05.jpg'],
    tags: ['Commercial', 'Retail', 'Bakery'],
    desc: 'A warm and inviting bakery that blends functionality with charm — efficient workflow for staff, cosy seating, and soft light throughout.',
    body: [
      'AM Architects presents a warm and inviting bakery design that blends functionality with charm.',
      'Focused on enhancing the customer experience, the layout features efficient workflow for staff, cosy seating areas, and a welcoming ambiance that highlights the artisanal nature of the products.',
      'Natural textures, soft lighting, and thoughtful detailing create a space where flavour and design come together.',
    ],
    facts: { area: 'TBC', completion: '2025', team: 'AM Architects' },
  },
  {
    id: 'p8', cat: 'residential',
    title: 'Vengat Residence',
    location: 'Tamil Nadu',
    year: '2025',
    size: 'project--md',
    img: 'images/p-vengat-hero.jpg',
    gallery: ['images/p-vengat-01.jpg', 'images/p-vengat-02.jpg'],
    tags: ['Residential', 'Villa'],
    desc: 'A personalised family residence — natural light, thoughtful layouts, and high-quality materials throughout.',
    body: [
      'At AM Architects, our residence designs are centred around creating personalised, functional, and aesthetically pleasing living spaces.',
      'We focus on crafting homes that reflect the unique needs and aspirations of each client, incorporating natural light, thoughtful layouts, and high-quality materials.',
      'Our designs seamlessly blend comfort, style, and sustainability, offering a modern living experience tailored to your lifestyle.',
    ],
    facts: { area: 'TBC', completion: '2025', team: 'AM Architects' },
  },
  {
    id: 'p9', cat: 'residential',
    title: 'VVG Residence',
    location: 'Tamil Nadu',
    year: '2025',
    size: 'project--md',
    img: 'images/p-vvg-hero.jpg',
    gallery: ['images/p-vvg-01.jpg'],
    tags: ['Residential', 'Villa'],
    desc: 'A contemporary residence with bold horizontal layers, warm timber accents, and a confident street presence.',
    body: [
      'At AM Architects, our residence designs are centred around creating personalised, functional, and aesthetically pleasing living spaces.',
      'VVG Residence balances a strong, layered facade with interiors shaped around natural light and generous, connected living areas.',
      'Our designs seamlessly blend comfort, style, and sustainability, offering a modern living experience tailored to your lifestyle.',
    ],
    facts: { area: 'TBC', completion: '2025', team: 'AM Architects' },
  },
  {
    id: 'p10', cat: 'residential',
    title: 'Dinesh Residence',
    location: 'Tamil Nadu',
    year: '2025',
    size: 'project--lg',
    img: 'images/p-dinesh-hero.jpg',
    gallery: ['images/p-dinesh-01.jpg', 'images/p-dinesh-02.jpg', 'images/p-dinesh-03.jpg', 'images/p-dinesh-04.jpg', 'images/p-dinesh-05.jpg', 'images/p-dinesh-06.jpg', 'images/p-dinesh-07.jpg'],
    tags: ['Residential', 'Family Home'],
    desc: 'A family home shaped around natural light and thoughtful layouts, with a full suite of interiors carried through by the studio.',
    body: [
      'At AM Architects, our residence designs are centred around creating personalised, functional, and aesthetically pleasing living spaces.',
      'Dinesh Residence was carried from first sketch through to interiors — living, dining, kitchen, bedrooms and joinery all detailed in-house so the language holds from the facade inward.',
      'Our designs seamlessly blend comfort, style, and sustainability, offering a modern living experience tailored to your lifestyle.',
    ],
    facts: { area: 'TBC', completion: '2025', team: 'AM Architects' },
  },
...
function initServices() {
  ...
  items.forEach(item => {
    ...
    item.addEventListener('mousemove', e => {
      ...
      preview.style.left = Math.max(10, Math.min(r.width - w - 10, x + 40)) + 'px';
      // CSS already applies translateY(-50%), so `top` is the cursor position itself —
      // subtracting half the height here would offset it twice and clip it out of the row.
...
/* ---------- 23. ADMIN PANEL ---------- */
/* ---------- 21c. HERO — rotating slides ---------- */
function initHeroSlides() {
  const wrap = document.getElementById('heroSlides');
  if (!wrap) return;
  const slides = Array.from(wrap.querySelectorAll('.hero__bg-image'));
...
/* ---------- 21d. STUDIO VIDEOS ---------- */
function initStudioVideos() {
  document.querySelectorAll('.vid').forEach(card => {
    const video = card.querySelector('.vid__el');
    const muteBtn = card.querySelector('.vid__mute');
    const frame = card.querySelector('.vid__frame');
    if (!video || !frame) return;

    const stopOthers = () => {
      document.querySelectorAll('.vid.is-playing').forEach(other => {
        if (other === card) return;
        const v = other.querySelector('.vid__el');
        if (v) v.pause();
    ...
    frame.addEventListener('click', (e) => {
      if (e.target.closest('.vid__mute')) return;
      if (video.paused) {
        stopOthers();
        video.play().catch(() => {});
    ...
    if ('IntersectionObserver' in window) {
      new IntersectionObserver((entries) => {
        entries.forEach(en => { if (!en.isIntersecting && !video.paused) video.pause(); });
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  safe('initStudioVideos', initStudioVideos);
